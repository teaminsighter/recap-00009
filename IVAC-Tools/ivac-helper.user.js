...
(function () {
        ...
        <div class="ivac-content" id="ivacContent">
            ...
            <div class="ivac-tab-content active" id="tabMain">
                <div class="ivac-section">
                    ...
                    <div class="ivac-row">
                        <input type="text" class="ivac-input" id="inputOtp" placeholder="OTP Code (when received)" maxlength="6" style="text-align:center; font-size:16px; letter-spacing:6px;">
                    </div>
                    <div class="ivac-row">
                        <button class="ivac-btn blue" id="btnSaveCredentials">Save</button>
                        <button class="ivac-btn orange" id="btnFillForm">Fill Form</button>
                        <button class="ivac-btn green" id="btnFillOtp">Fill OTP</button>
                    </div>
                </div>
    ...
    function fillOtp() {
        ...
        if (filled > 0) {
            log(`OTP filled in ${filled} field(s)`, '#4caf50');
            playSuccess();
            ...
            setTimeout(() => {
                ...
                for (const btn of buttons) {
                    ...
                    if (text.includes('verify') || text.includes('submit') || text.includes('confirm')) {
                        log('Found verify button, clicking...', '#ff9800');
                        btn.click();
                        return;
                    }
                }
            ...
            log('No OTP field found on page', '#f44336');
        }
    }
